...
<head>
    ...
    <meta name="keywords" content="Biaya masuk, biaya pesantren, pondok pesantren, tahfidz, Al Ashr Al Madani, generasi hafidz, da'i, qori">
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "name": "Biaya Pondok Pesantren Tahfidz Al Ashr Al Madani",
            "description": "Biaya Pondok pesantren Al Ashr Al Madani adalah salah satu pesantren tahfidz di kota bandung yang memiliki moto mencetak generasi hafidz hafidzoh da'i da'iyyah qori qori'ah",
            "url": "https://pptqam.ponpes.id/",
            "logo": "https://pptqam.ponpes.id/src/img/logo.svg"
        }
    </script>
    <!-- meta social media-->
    <meta property="og:title" content="Biaya PPTQAM">
    <meta property="og:description" content="Biaya pondok pesantren tahfidzul quran Al 'Ashr Al Madani ">
    <meta property="og:image" content="https://pptqam.ponpes.id/src/img/uploaded/og-image/pptqam.png">
    <meta property="og:image:alt" content="Biaya PPTQAM">
    ...
    <link rel="canonical" href="https://pptqam.ponpes.id/biaya">
    <title>Biaya | Al 'Ashr Al Madani</title>
    <!-- favicon.io -->
