...
<head>
    ...
    <meta name="title" content="PPTQAM">
    <meta name="description" content="gallery Pondok pesantren Al Ashr Al Madani adalah salah satu pesantren tahfidz di kota bandung yang memiliki moto mencetak generasi hafidz hafidzoh da'i da'iyyah qori qori'ah">
    <meta name="keywords" content="gallery, tahfidz di bandung,pondok pesantren, tahfidz, Al Ashr Al Madani, generasi hafidz, da'i, qori">
    <meta name="author" content="ponpes_am">
    ...
    <!-- meta social media-->
    <meta property="og:title" content="Login Pesantren">
    <meta property="og:description" content="Login to dashbord Pondok pesantren Al Ashr Al Madani adalah salah satu pesantren tahfidz di kota bandung yang memiliki moto mencetak generasi hafidz hafidzoh da'i da'iyyah qori qori'ah ">
    <meta property="og:image" content="https://pptqam.ponpes.id/src/img/uploaded/og-image/pptqam.png">
    <meta property="og:image:alt" content="login Al Ashr Al Madani">
    ...
    <link rel="canonical" href="https://pptqam.ponpes.id/login">
    <title>Login</title>
...
<body class="bg-blue-100">
    ...
    ?>
    <div class="w-[90%] lg:w-[60%] mx-auto mb-[50px] gap-5">
        <div class="flex flex-col gap-5">
            ...
            <div class="w-full bg-white shadow-sm py-5 px-3 rounded-xl flex gap-5 text-white justify-center items-center flex-col lg:flex-row">
                <a  class="rounded-xl w-full bg-dark-font py-2 px-5 font-medium flex items-center justify-center gap-1 text-sm cursor-pointer hover:bg-main-green" id="btn-lg-code">
                    <img src="<?= baseUrl("src/img/icons/barcode.svg"); ?>" alt="" class="w-7">
                    Login Dengan Kode
                </a>
                <a  class="rounded-xl w-full bg-dark-font text-sm py-2 px-5 font-medium flex items-center justify-center gap-1 cursor-pointer hover:bg-main-green" id="btn-lg-pass">
