<section class="container-extracurricular p-5 bg-white">
  ...
  <swiper-container class="mySwiper display-extracurricular  w-[85%] h-[200px] sm:w-[70%] sm:h-[280px]" effect="cards" grab-cursor="true" autoplay-delay="2000" autoplay-disable-on-interaction="false">
    ...
    <swiper-slide style="background-color: #77B341;" class=" overflow-hidden">
      <div>
        <img class="relative z-10  bg-cover" src="./src/img/hilmi.png" alt="pencaksilat" loading="lazy">
        <div class="title-extracurricular flex flex-col justify-center  z-10 absolute bottom-0 left-0 h-[40px] w-full text-center items-center sm:h-[60px]">
          <h3 class="m-auto ">Pencaksilat</h3>
        </div>
    ...
    <swiper-slide style="background-color: #77B341;" class=" overflow-hidden">
      <div>
        <img class="relative z-10" src="./src/img/panahan.png" alt="pencaksilat" loading="lazy">
        <div class="title-extracurricular flex flex-col justify-center  z-10 absolute bottom-0 left-0 h-[40px] w-full text-center items-center sm:h-[60px]">
          <h3 class="m-auto ">Pencaksilat</h3>
        </div>
        <img src="<?= baseUrl("src/img/program_pilihan/vector.png"); ?>" alt="al ashr al madani" class="bg-cover absolute top-[-25px] right-[-30px] w-[40%] " />
