<section class="-mt-1 pt-8  bg-[url('../img/hiro.svg')] w-full bg-no-repeat bg-cover bg-body" style="background-position: center 100%">
    ...
    <div class="swiper swiper-card">
        ...
        <div class="lg:ml-44 md:ml-2 ml-1 prev swiper-button-prev w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-second-blue p-1 top-[10rem] lg:top-32 max-md:hidden">
            <img src="<?= base_url("src/img/arrow-left.svg"); ?>" alt="left" class="invert hue-rotate-[160deg] contrast-200">
        </div>
        <div class="lg:mr-44 md:mr-2 mr-1 next swiper-button-next w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-second-blue p-1 top-[10rem] lg:top-32 max-md:hidden">
