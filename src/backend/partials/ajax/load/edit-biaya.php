...
$db = new Database();
$query = "SELECT pgb_id FROM program_biaya WHERE prg_id IN (1)";
$db->query($query);
$db->execute();
$biayaSmp = $db->single();
?>
...
<div id="show-edit-biaya">
    <div class="flex gap-5">
        ...
        <a href="#edit-biaya-smp" class="group/kategori group-focus/text:bg-dark-font w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl items-center hover:bg-main-green focus:bg-dark-font flex gap-2 justify-center" id="btn-edit-biaya-smp" onclick="inputBiayaSmpSma();">
        ...
        <a href="#edit-biaya-sma" class="group/kategori group-focus/text:bg-dark-font w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl items-center hover:bg-main-green focus:bg-dark-font flex gap-2 justify-center" id="btn-edit-biaya-sma" onclick="inputBiayaSmpSma();">
            <div class="group/text text-xl font-bold group-hover/kategori:text-white group-focus/kategori:text-white focus:text-white flex gap-2 justify-center ">
                <i class='bx bxs-edit bx-md group-hover/kategori:text-white group-focus/kategori:text-white focus:text-white'></i>
                Edit Biaya SMA
            </div>
    ...
    <div class="hidden" id="input-biaya-smp">
        <form action="<?= baseUrl('src/backend/partials/dashboard/edit-biaya/edit-biaya.php'); ?>" method="post" id="identitas-santri-am">
        <input type="hidden" name="prg_id" value=" <?=$biaya['prg_id'];?>">
        <input type="hidden" name="id" value=" <?=$biaya['pgb_id'];?>">
            <div class="flex flex-col lg:flex-row gap-5 my-5">
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_pendaftaran" type="number" placeholder="Masukkan Nominal biaya Pendaftaran" name="biaya_daftar">
                </div>
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    <label class="block text-gray-700 text-sm sm:text-base md:text-md font-bold mb-2" for="biaya_masuk">Biaya Masuk</label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_masuk" type="number" placeholder="Masukkan Nominal biaya Masuk" name="biaya_masuk">
                </div>
            </div>
            <div class="flex gap-5 flex-col lg:flex-row my-5">
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_tahunan" type="number" placeholder="Masukan Nominal biaya Tahunan" name="biaya_year">
                </div>
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    <label class="block text-gray-700 text-sm sm:text-base md:text-md font-bold mb-2" for="biaya_bulanan">Biaya Bulanan</label>
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_bulanan" type="number" placeholder="Masukan Nominal biaya Bulanan" name="biaya_month">
                </div>
            </div>
            <div class="flex gap-5 flex-col lg:flex-row my-5">
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_seragam_putra" type="number" placeholder="Masukan Nominal biaya Seragam Putra" name="biaya_seragam_pa">
                </div>
                <div class="w-full lg:w-1/2 bg-white shadow-sm py-5 px-3 rounded-xl">
                    ...
                    <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="biaya_seragam_putri" type="number" placeholder="Masukan Nominal biaya Seragam Putri" name="biaya_seragam_pi">
                </div>
            </div>
