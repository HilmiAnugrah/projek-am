        ...
        <div class="w-full bg-white shadow-sm py-5 px-3 rounded-xl mt-5">
            <div class="flex flex-col gap-5 items-start">
                ...
                <div class="flex flex-col justify-between w-full gap-5">
                    ...
                    <div class="flex flex-col gap-2 items-start w-full">
                    <label for="gaji_ayah" class="block text-gray-700 text-sm sm:text-base md:text-md font-bold">Rata Rata Gaji Ayah</label>
                    <select class="border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline placeholder:text-sm" id="gaji_ayah" type="number" max="100">
                        <option value="default" disabled selected>Pilih</option>
