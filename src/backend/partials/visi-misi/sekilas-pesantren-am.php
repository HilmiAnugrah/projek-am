<section class="h-[500px] py-10 w-full bg-no-repeat bg-cover bg-[center_100%] bg-main-purple">
    <div class="flex flex-col justify-center items-center gap-5 items-center h-full">
