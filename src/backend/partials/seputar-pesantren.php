<section class="w-full pb-12 container-wrapper bg-body">
    <h2 class="py-6 text-2xl font-bold text-center sm:text-4xl text-dark-font">
        Seputar Pesantren
    </h2>
    <div class="wrapper-content w-[90%] mx-auto grid grid-cols-3 md:flex flex-rows justify-center items-center gap-[2em] lg:gap-12 sm:gap-[2em] md:gap-5">
        ...
        <div class="flex flex-col items-center gap-2 cursor-pointer justify-bottom md:gap-1" id="menu-category">
            ...
            <p class="text-sm font-medium text-center sm:text-base md:text-sm sm:font-medium text-dark-font">Semua Menu</p>
        </div>
    </div>
</section>