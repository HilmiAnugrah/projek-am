    ...
    <nav id="nav-menu" class="hidden overflow-y-auto lg:overflow-y-visible text-dark-font bg-white lg:bg-body max-lg:w-full max-lg:h-[100vh] absolute top-[100%] left-0 lg:block lg:text-white lg:static lg:bg-transparent">
      <ul class="px-6 lg:flex lg:items-center">
        <li class="max-lg:mt-8 font-bold lg:mr-8">
          <a href="<?= baseUrl(); ?>" class="block">Beranda</a>
        </li>
          ...
          <div class="group/about">
            ...
            <div id="dropdown-about" class="hidden lg:absolute lg:transition-all lg:right-0 lg:z-10 lg:origin-top-right lg:rounded-lg bg-body lg:shadow-lg lg:ring-1 lg:w-[500px] lg:ring-black lg:ring-opacity-5 p-4 lg:group-hover/about:scale-100 lg:group-hover/about:block rounded-lg lg:translate-x-1/3">
              <div class="bg-body lg:bg-white rounded-lg flex flex-col gap-1">
                ...
                <a href="https://profile.pptqam.ponpes.id/pendiri-pesantren/" class="text-main-purple flex gap-3 px-4 items-center py-2 text-sm lg:text-xl font-bold hover:bg-young-blue tracking-wide rounded-lg bg-white">
                  <div class="bg-body w-7 h-7 lg:w-10 lg:h-10 rounded-lg flex justify-center items-center">
                ...
                <a href="https://profile.pptqam.ponpes.id/asatidz-asatidzah/" class="text-old-yellow flex gap-3 px-4 items-center py-2 text-sm lg:text-xl font-bold hover:bg-young-blue tracking-wide rounded-lg bg-white">
                  <div class="bg-body w-7 h-7 lg:w-10 lg:h-10 rounded-lg flex justify-center items-center">
                ...
                <a href="https://profile.pptqam.ponpes.id/guru-guru/" class="text-dark-font flex gap-3 px-4 items-center py-2 text-sm lg:text-xl font-bold hover:bg-young-blue tracking-wide rounded-lg bg-white">
                  <div class="bg-body w-7 h-7 lg:w-10 lg:h-10 rounded-lg flex justify-center items-center">
                    <svg class="w-7 h-7" viewBox="0 0 304 304" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://profile.pptqam.ponpes.id/fasilitas/" class="text-jingga flex gap-3 px-4 items-center py-2 text-sm lg:text-xl font-bold hover:bg-young-blue tracking-wide rounded-lg bg-white">
                  <div class="bg-body w-7 h-7 lg:w-10 lg:h-10 rounded-lg flex justify-center items-center">
                    <svg class="w-7 h-7" viewBox="0 0 300 270" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <title>Fasilitas</title>
                      <desc>Fasilitas Al 'Ashr Al Madani</desc>
                      <path d="M285 120H255V30H270V0H30V30H45V120H15C11.0218 120 7.20644 121.58 4.3934 124.393C1.58035 127.206 0 131.022 0 135V270H300V135C300 131.022 298.42 127.206 295.607 124.393C292.794 121.58 288.978 120 285 120ZM180 240V180H120V240H75V30H225V240H180Z" fill="#0CA49D" />
        ...
        <li class="max-lg:mt-8 lg:mr-8 font-bold relative">
          <div class="group/ppdb">
            ...
            <div id="dropdown-ppdb" class="hidden lg:absolute lg:transition-all lg:right-0 lg:z-10 lg:origin-top-right rounded-lg bg-body lg:shadow-lg lg:ring-1 lg:ring-opacity-5 lg:group-hover/ppdb:scale-100 lg:group-hover/ppdb:block lg:p-4 p-4  lg:w-[450px] lg:translate-x-1/3">
              <div class="bg-body lg:bg-white rounded-lg flex flex-col gap-1">
                <a href="https://ppdb.pptqam.ponpes.id/" class="text-main flex gap-3 px-4 items-center py-3 lg:py-2 text-sm sm:text-base lg:text-xl lg:font-bold
                ...
                <a href="https://pptqam.ponpes.id/biaya" class="text-main-orange bg-white flex gap-3 px-4 items-center py-3 lg:py-2 text-sm sm:text-base lg:text-xl lg:font-bold tracking-wide hover:bg-young-blue rounded-lg">
                  <div class="bg-body w-7 h-7 lg:w-10 lg:h-10 rounded-lg flex justify-center items-center">
