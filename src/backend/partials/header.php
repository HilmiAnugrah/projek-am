<header>
    <div id="nav-wrapper" class="absolute top-0 left-0 z-50 flex items-center w-full shadow-lg  px-7 text-body lg:justify-around lg:text-white">
        ...
        <button id="hamburger-menu" class="absolute z-10 block right-4 lg:hidden" type="button">
        ...
        <nav id="nav-menu" class="hidden overflow-y-auto lg:overflow-y-visible text-dark-font bg-white lg:bg-body max-lg:w-full max-lg:h-[100vh] absolute top-[100%] left-0 lg:block lg:text-white lg:static lg:bg-transparent">
            <ul class="px-6 lg:flex lg:items-center">
                <li class="font-bold max-lg:mt-8 lg:mr-8">
                    <a href="<?= base_url(); ?>" class="block">Home</a>
                </li>
                <li class="relative font-bold max-lg:mt-8 lg:mr-8">
                    <div class="group/about">
                        <button type="button" class="inline-flex items-center w-full gap-x-2" id="about">
                            About
                            <svg xmlns=" http://www.w3.org/2000/svg" width="15" class="transition-all lg:group-hover/about:rotate-180" viewBox="0 0 20 20">
                        ...
                        <div id="dropdown-about" class="hidden p-4 scale-0 rounded-lg lg:absolute lg:transition-all lg:right-0 lg:z-10 lg:w-56 lg:origin-top-right lg:rounded-lg bg-body lg:shadow-lg lg:ring-1 lg:ring-black lg:ring-opacity-5 lg:group-hover/about:scale-100 lg:group-hover/about:block lg:translate-x-1/3">
                            <div class="flex flex-col gap-1 rounded-lg bg-body lg:bg-white">
                                <a href="#" class="flex items-center gap-3 px-4 py-2 text-sm tracking-wide bg-white rounded-lg text-dark-font lg:text-md hover:bg-young-blue">
                                    1
                                </a>
                                <a href="#" class="flex items-center gap-3 px-4 py-2 text-sm tracking-wide bg-white rounded-lg text-dark-font lg:text-md hover:bg-young-blue">
                                    2
                ...
                <li class="relative font-bold max-lg:mt-8 lg:mr-8">
                    <div class="group/ppdb">
                        <button type="button" class="inline-flex items-center w-full gap-x-2" id="ppdb">
                            PPDB
                            <svg xmlns=" http://www.w3.org/2000/svg" width="15" class="transition-all lg:group-hover/ppdb:rotate-180" viewBox="0 0 20 20">
                                <path d="M10 0C4.486 0 0 4.486 0 10C0 15.514 4.486 20 10 20C15.514 20 20 15.514 20 10C20 4.486 15.514 0 10 0ZM10 14.414L4.293 8.707L5.707 7.293L10 11.586L14.293 7.293L15.707 8.707L10 14.414Z" fill="currentColor" />
                            </svg>
                        </button>
                        <div id="dropdown-ppdb" class="hidden lg:absolute scale-0 lg:transition-all lg:right-0 lg:z-10 lg:origin-top-right rounded-lg bg-body lg:shadow-lg lg:ring-1 lg:ring-opacity-5 lg:group-hover/ppdb:scale-100 lg:group-hover/ppdb:block lg:p-4 p-4  lg:w-[450px] lg:translate-x-1/3">
                            <div class="flex flex-col gap-1 rounded-lg bg-body lg:bg-white">
                                <a href="#" class="flex items-center gap-3 px-4 py-3 text-sm tracking-wide bg-white rounded-lg text-dark-font lg:py-2 sm:text-base lg:text-xl lg:font-bold hover:bg-young-blue">
                                    <div class="flex items-center justify-center rounded-lg bg-body w-7 h-7 lg:w-10 lg:h-10">
                ...
                <li class="relative font-bold max-lg:mt-8 lg:mr-8">
                    <div class="group/contact">
                        <button type="button" class="inline-flex items-center w-full gap-x-2" id="contact">
                            Contact
                            <svg xmlns=" http://www.w3.org/2000/svg" width="15" class="transition-all lg:group-hover/contact:rotate-180" viewBox="0 0 20 20">
                                <path d="M10 0C4.486 0 0 4.486 0 10C0 15.514 4.486 20 10 20C15.514 20 20 15.514 20 10C20 4.486 15.514 0 10 0ZM10 14.414L4.293 8.707L5.707 7.293L10 11.586L14.293 7.293L15.707 8.707L10 14.414Z" fill="currentColor" />
                            </svg>
                        </button>
                        <div id="dropdown-contact" class="hidden p-4 scale-y-0 rounded-lg lg:absolute lg:transition lg:right-0 lg:z-10 lg:w-96 lg:origin-top-right lg:bg-body lg:shadow-lg lg:ring-1 lg:ring-black lg:ring-opacity-5 lg:group-hover/contact:scale-100 lg:group-hover/contact:block lg:translate-x-1/3">
                            <div class="flex flex-col gap-1 p-4 rounded-lg bg-body lg:bg-white">
                ...
                <li>
                    <a href="#" class="block py-5 mt-5 text-center text-white rounded-full bg-main md:hidden">Login</a>
                </li>
            </ul>
        </nav>
    </div>
